    ...
    def calibration_plot(self, zip_name, file_name, 
        ...
        for m, zip_file in enumerate(MY_MODELS):
            ...
            for sd_i, sd in enumerate(test_sd_array):
                ...
                for id_ in range(1, num_instances): # change this

                    # 'rnn_n_f_p_0_res_rt_bin_d_f_p_0_1_a_4_n_300_te_50000_id_{}_fixed_res_rt_bin_p_{}_a_4_n_300_run_{}.zip',
                            
                    for run in range(num_runs):
                        
                        # extract files
                        zip_handler = zip2csv(path_to_data = self.path_to_data, zip_file_name=zip_file.format(id_, sd_, run))
                        ...
                        for rin in range(num_rins):
                            ...
                            file_name_i = file_name.format(id_, sd_, run, rin)
                            zip_handler.extract_file(file_name_i)
                            
                            # 'rnn_n_f_p_0_res_rt_bin_d_f_p_0_1_a_4_n_300_te_50000_id_{}_fixed_res_rt_bin_p_{}_a_4_n_300_run_{}_rin_{}.csv'
                            ...
                            # append accuracy 
                            ss_acc.append(sum(choice == higher_rew)/len(choice))
                            
                            # delete file
                            zip_handler.delete_file(file_name_i)
                            
                        # take mean of accuracy for reward instances
